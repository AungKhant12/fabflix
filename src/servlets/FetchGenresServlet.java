...
@WebServlet(name = "FetchGenresServlet", urlPatterns = "/api/fetch-genres")
public class FetchGenresServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            String query = "select name genre_name, id genre_id from genres;";
            ...
            while (resultSet.next()) {
                ...
                // hoist
                resObj.addProperty("genre_name", genreName);
                resObj.addProperty("genre_id", genreId);
